...
\item compliment
  \subitem A polite expression of praise or admiration.
\item Venn diagram
  \subitem A graphical representation of a \term{set} by enclosing a region with circular lines.

\item sequence
  \subitem A list of objects in some order.

\item tuple(s)
  \subitem A finite \term{sequence}.

\item k-tuple
  \subitem A \term{sequence} with $k$ elements.

\item pair
  \subitem A \term{sequence} with 2 elements.
